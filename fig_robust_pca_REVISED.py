...
It then returns the bootstrapped function.
    This code meanwhile sets input data (based off the parameters of an ellipse)
and then creates random outlier points drawn from a bivariate normal distribution
'''
